...
// ContactListOptions are options for listing contacts.
...
func (c *ContactClient) List(ctx context.Context, opts *ContactListOptions) (*types.ContactListResponse, error) {
	query := url.Values{}
	if opts != nil {
		if opts.Cursor != nil {

...
// BlueprintListOptions are options for listing blueprints.
...
func (c *BlueprintClient) List(ctx context.Context, opts *BlueprintListOptions) (*types.BlueprintListResponse, error) {
	query := url.Values{}
	if opts != nil {
		if opts.Cursor != nil {

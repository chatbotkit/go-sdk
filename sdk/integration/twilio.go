...
// TwilioListOptions are options for listing Twilio integrations.
type TwilioListOptions struct {
	Cursor *string
	Order  *string
	Take   *int
}
...
func (c *TwilioClient) List(ctx context.Context, opts *TwilioListOptions) (*types.IntegrationTwilioListResponse, error) {
	query := url.Values{}
	if opts != nil {
		if opts.Cursor != nil {

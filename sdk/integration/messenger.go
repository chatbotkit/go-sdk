...
// MessengerListOptions are options for listing Messenger integrations.
type MessengerListOptions struct {
	Cursor *string
	Order  *string
	Take   *int
}
...
func (c *MessengerClient) List(ctx context.Context, opts *MessengerListOptions) (*types.IntegrationMessengerListResponse, error) {
	query := url.Values{}
	if opts != nil {
		if opts.Cursor != nil {
